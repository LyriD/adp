module Spree
  module BaseHelper
    ...
    def taxons_tree(root_taxon, current_taxon, max_level = 1)
      ...
      content_tag :ul, class: 'taxons-list' do
        root_taxon.children.map do |taxon|
          css_class = (current_taxon && current_taxon.self_and_ancestors.include?(taxon)) ? 'current_taxon' : nil
    ...
    def create_product_image_tag(image, product, options, style)
      ...
      options.reverse_merge! data: {'zoom-image' => image.attachment.url(:large)}
